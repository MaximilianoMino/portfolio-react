...
import old_portfolio from '../assets/projects/old_portfolio.png';
...
export const DataProvider = ({ children }) => {
  ...
  useEffect(() => {
    setImages({
      phone, logo, folder, settings, proyectos, timedate, enlarge, minimize, close, mail, CV, linkedinLogo, githubLogo, maxi_cuadrada, paint, sky, computer, colorunderline, experience, calendar, profesion, notepad, ie, shutdown, warning, cursame, logoff, run, help, find, update, old_portfolio, store, date_admin
    });
  ...
  return (
    <DataContext.Provider value={{
      images, currentWindow, setCurrentWindow, closeClick, closeWindow, setCloseWindow
    }}>
      {children}
